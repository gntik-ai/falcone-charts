/**
 * Public package/CLI contracts for the 0.4.19 forward-recovery candidate.
 *
...
test('bbx-repair-staging-071 packaged forward recovery is independent of repair executable mode', () => {
  ...
  try {
    ...
    assert.equal(candidate.version, targetVersion, 'the corrected package must be 0.4.19')
  } finally {
    candidate.cleanup()
  }
})
